...
function App() {
  ...
  // Efecto para actualizar posición cuando cambia el paso
  useEffect(() => {
    if (showTour) {
  ...
  // Efecto para eventos de scroll y resize
  useEffect(() => {
    if (!showTour) return;
  ...
  // Calcular posición de la tarjeta del tour
  const getCardStyle = () => {
