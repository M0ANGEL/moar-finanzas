...
// export const fetchPockets = async (userId, listId) => {
//   if (!userId) return [];
//   let query = supabase.from('pockets').select('*').eq('user_id', userId);
//   if (listId) query = query.eq('list_id', listId);
...
// export const fetchFixedItems = async (userId, listId) => {
//   if (!userId) return [];
//   let query = supabase.from('fixed_items').select('*').eq('user_id', userId);
//   if (listId) query = query.eq('list_id', listId);
//   const { data, error } = await query;
//   if (error) throw error;
//   return data;
...
// export const fetchReceivables = async (userId, listId) => {
//   if (!userId) return [];
//   let query = supabase.from('receivables').select('*').eq('user_id', userId);
//   if (listId) query = query.eq('list_id', listId);
//   const { data, error } = await query;
//   if (error) throw error;
//   return data;
